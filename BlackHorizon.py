...
BLACKHORIZON_BANNER = 'BlackHorizon Clound Based DDoS Tool Created By CyberSecurty'
...
class BlackHorizon(object):
    ...
    # Containers
    cloundsQueue = []                                                  ###############################
    manager = None                                                     #~~~~Created By CyberSecurty~~~~#
    useragents = []                                                    #~~~~~~~~~~Fikri Anil Sahin~~~~~~~~~~#
                                                                                  #~~~~~~~~~~Github: CyberSecurty~~~~~#
    # Properties                                                       #~~~~~~~~~~~?nstegram:@anils2002~~~~#
    url = None                                                         ###############################
...
def usage():
    print BLACKHORIZON_BANNER 
    print ' Windows: BlackHorizon.py http://www.hedefsite.com'
    print ' Linux/Termux: python2 BlackHorizon.py http://www.hedefsite.com'
    ...
    print ' Github: CyberSecurty'
    print '?nstegram: anils2002'
    print "\a"
print \
"""                                                       
           .          .           .     .                .       .
